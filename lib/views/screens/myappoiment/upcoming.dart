...
class _UpcomingAppointmentsState extends State<UpcomingAppointments> {
  ...
  Future<DocumentSnapshot> getDoctorDetails(String doctorId) async {
    try {
      ...
      Get.snackbar('Error', 'Failed to retrieve doctor details',
          snackPosition: SnackPosition.BOTTOM);
      rethrow;
    }
  }
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(widget.appointment['date'] ?? 'N/A', style: const TextStyle(fontWeight: FontWeight.bold))
                  ],
                ),
                const SizedBox(
                  width: 30,
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(widget.appointment['time'] ?? 'N/A', style: const TextStyle(fontWeight: FontWeight.bold))
                  ],
                ),
                const SizedBox(width: 35,),
                 Column(
                  ...
                  children: [
                    ...
                    Text(widget.specialty, style: const TextStyle(fontWeight: FontWeight.bold))
                  ],
                ),
              ],
            ),
