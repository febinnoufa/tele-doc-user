            ...
            const Center(
              child: Column(
                children: [
                  ...
                  Text("Please Enter Your Register Mobile Number",style: TextStyle(fontSize: 15,fontStyle: FontStyle.italic),),
                   SizedBox(height: 20,),
                  Text("To Receive a Verification Code",style: TextStyle(fontSize: 15,fontStyle: FontStyle.italic),)
                ],
              ),
            ),
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                 ...
                 //   controller.singup();
                  ...
                  child:cntr.loading.value ? CircularProgressIndicator( ) : Text("Send") ,
